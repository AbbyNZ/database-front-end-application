namespace GreensGarage
{
    partial class DataModule
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Green = new System.Data.OleDb.OleDbConnection();
            ...
            this.DSGreen = new GreensGarage.GreenDataSet();
            ...
            this.oleDbSelectCommand1.CommandText = "SELECT EquipmentID, Description\r\nFROM            EQUIPMENT\r\nORDER BY Equip" +
                "mentID";
            this.oleDbSelectCommand1.Connection = this.Green;
            // 
            // Green
            // 
            this.Green.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=E:\\Berna\\Unitec\\2nd Sem 2015\\GUI\\Assignment2\\GreensGarageBatanb02\\Green.mdb";
            // 
            // oleDbInsertCommand1
            // 
            this.oleDbInsertCommand1.CommandText = "INSERT INTO `EQUIPMENT` (`Description`) VALUES (?)";
            this.oleDbInsertCommand1.Connection = this.Green;
            ...
            this.oleDbUpdateCommand1.Connection = this.Green;
            ...
            this.oleDbDeleteCommand1.Connection = this.Green;
            ...
            this.oleDbUpdateCommand2.Connection = this.Green;
            ...
            this.oleDbDeleteCommand2.Connection = this.Green;
            ...
            this.oleDbUpdateCommand3.Connection = this.Green;
            ...
            this.oleDbDeleteCommand3.Connection = this.Green;
            ...
            this.daService.RowUpdated += new System.Data.OleDb.OleDbRowUpdatedEventHandler(this.daService_RowUpdated);
            // 
            // oleDbSelectCommand4
            // 
            this.oleDbSelectCommand4.CommandText = "SELECT        ServiceTypeID, Description, HourlyRate\r\nFROM            SERVICETYPE" +
                "\r\nORDER BY ServiceTypeID";
            this.oleDbSelectCommand4.Connection = this.Green;
            // 
            // oleDbInsertCommand4
            // 
            this.oleDbInsertCommand4.CommandText = "INSERT INTO `SERVICETYPE` (`Description`, `HourlyRate`) VALUES (?, ?)";
            this.oleDbInsertCommand4.Connection = this.Green;
            ...
            this.oleDbUpdateCommand4.Connection = this.Green;
            ...
            this.oleDbDeleteCommand4.CommandText = "DELETE FROM `SERVICETYPE` WHERE ((`ServiceTypeID` = ?) AND ((? = 1 AND `Descripti" +
                ...
                "HourlyRate` = ?)))";
            this.oleDbDeleteCommand4.Connection = this.Green;
            ...
            this.oleDbUpdateCommand5.Connection = this.Green;
            ...
            this.oleDbDeleteCommand5.CommandText = "DELETE FROM `SERVICETYPEEQUIPMENT` WHERE ((`ServiceTypeID` = ?) AND (`EquipmentID" +
                "` = ?))";
            this.oleDbDeleteCommand5.Connection = this.Green;
            ...
            this.daServiceTypeEquipment.RowUpdated += new System.Data.OleDb.OleDbRowUpdatedEventHandler(this.daServiceTypeEquipment_RowUpdated);
            // 
            // oleDbSelectCommand6
            // 
            this.oleDbSelectCommand6.CommandText = "SELECT        VehicleID, PlateNumber, Make, Model, OwnerID\r\nFROM            VEHIC" +
                "LE\r\nORDER BY VehicleID";
            this.oleDbSelectCommand6.Connection = this.Green;
            // 
            // oleDbInsertCommand6
            // 
            this.oleDbInsertCommand6.CommandText = "INSERT INTO `VEHICLE` (`PlateNumber`, `Make`, `Model`, `OwnerID`) VALUES (?, ?, ?" +
                ", ?)";
            this.oleDbInsertCommand6.Connection = this.Green;
            ...
            this.oleDbUpdateCommand6.Connection = this.Green;
            ...
            this.oleDbDeleteCommand6.Connection = this.Green;
        ...
        private System.Data.OleDb.OleDbConnection Green;
